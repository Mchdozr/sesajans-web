  ...
  const footerGroups = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Adana Sahne Aydınlatma", href: "/adana-sahne-aydinlatma" },
        { label: "Gaziantep Sahne Aydınlatma", href: "/gaziantep-sahne-aydinlatma" },
        { label: "Kocaeli Sahne Aydınlatma", href: "/kocaeli-sahne-aydinlatma" },
