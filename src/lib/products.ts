...
const catalog: Product[] = [
  {
    ...
    intro:
      "Beam King 380, sahne ve etkinlik prodüksiyonları için tasarlanmış profesyonel bir beam moving head ünitesidir. 380W güç kaynağı, 2° ultra dar beam açısı ve zengin efekt seti ile uzun mesafede keskin ışık demetleri üretir. Konser, festival, gece kulübü ve TV stüdyosu uygulamalarında güvenilir performans sunar. Beam King 380 fiyat teklifi için iletişime geçin.",
    highlights: [
    ...
    faqs: [
      ...
      {
        q: "Beam King 380 fiyat / teklif nasıl alınır?",
        a: "Güncel fiyat stok ve adede göre değişir. İletişim formundan proje detayınızı paylaşın; ücretsiz teklif hazırlarız.",
      },
    ],
    keywords: [
      "beam moving head",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "Beam King IP fiyat / teklif nasıl alınır?",
        a: "IP66 beam fiyatı konfigürasyon ve adede göre değişir. Ücretsiz teklif için iletişim formunu doldurun.",
      },
    ],
    keywords: [
      "ip66 beam",
      "dış mekan moving head",
      "cmy beam",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "Blinder 400 / molfez fiyat teklifi nasıl alınır?",
        a: "LED tipi (WW/CW/RGBW) ve adede göre güncel fiyat hazırlanır. İletişim formundan teklif isteyin.",
      },
    ],
    keywords: [
      "blinder 400",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "Blinder 800 fiyat / teklif nasıl alınır?",
        a: "Büyük sahne molfez/blinder fiyatı adet ve LED opsiyonuna göre değişir. Ücretsiz teklif için bize yazın.",
      },
    ],
    keywords: [
      "blinder 800",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "Diamond Line LED bar fiyat / teklif nasıl alınır?",
        a: "Modül adedi ve uzunluğa göre teklif hazırlanır. Proje ölçünüzü paylaşın.",
      },
    ],
    keywords: [
      "led bar",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "LED Beam Wash 150 fiyat / teklif nasıl alınır?",
        a: "Kulüp ve DJ paketleri için güncel fiyat teklifi iletişim formundan alınır.",
      },
    ],
    keywords: [
      "beam wash 150",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "Strike Pro IP fiyat / teklif nasıl alınır?",
        a: "Strobe/wash 2in1 ünite fiyatı adede göre değişir. Ücretsiz teklif için iletişime geçin.",
      },
    ],
    keywords: [
      "strike pro",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "Tornado IP fiyat / teklif nasıl alınır?",
        a: "5 başlı moving LED bar fiyatı proje adedine göre netleşir. Teklif formundan yazın.",
      },
    ],
    keywords: [
      "tornado ip",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "Wash 3715 fiyat / teklif nasıl alınır?",
        a: "Robot boyama ışık / wash moving head fiyatı adede göre değişir. Ücretsiz teklif için iletişime geçin.",
      },
    ],
    keywords: [
      "wash 3715",
