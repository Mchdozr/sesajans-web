export const dictionary = {
  ...
  search: {
    ...
    eyebrow: "Arama",
    description: "Ürün, blog yazısı, sözlük terimi, karşılaştırma ve proje içeriklerinde arayın.",
    placeholder: "Ürün, terim veya konu arayın… (ör. beam, DMX, düğün)",
    label: "Ara",
    noResults: "Sonuç bulunamadı. Farklı bir anahtar kelime deneyin.",
    resultsFor: "sonuç",
    minChars: "Aramak için en az 2 karakter girin.",
    groups: {
      product: "Ürün",
      blog: "Blog",
      glossary: "Sözlük",
  ...
  homeFaqs: [
    ...
    },
    {
      ...
      a: "İletişim formu, telefon veya WhatsApp ile proje detaylarınızı paylaşın. 1 iş günü içinde ürün önerisi ve fiyat teklifi alırsınız. Detaylı süreç için Satın Al sayfasını inceleyin.",
    },
    {
